...
import com.example.movieinfoapp.databinding.FragmentDetailBinding
...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.movies.observe(
            ...
            Observer { movies ->
                Glide.with(this)
                    .load("https://image.tmdb.org/t/p/w1280${movies.backdropPath}")
                    .transform(CenterCrop())
                    .into(binding.movieBackdrop)

                Glide.with(this)
                    .load("https://image.tmdb.org/t/p/w342${movies.posterPath}")
                    .transform(CenterCrop())
